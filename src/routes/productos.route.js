...
const { genericMiddleware,formatoMiddleware } = require('../middlewares/index')
...
// Tablas Intermedias
route.post('/productos/:id/fabricantes',genericMiddleware.validateId(Producto),formatoMiddleware.validateFormat,productosController.productMaker)
